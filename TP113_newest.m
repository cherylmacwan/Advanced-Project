...
%% Indexes
ndx=[609 610 611 612 613 593 594 595 596 597 575 578 579 580 581 598 616 630 660 671 705 793 791 790 809 808 807 788 787 786 768 754 743 730 729 718 717 711 702 701 694 679 686 670 669 668 663 659 658 651 646 645 636 625 626 ];
...
%         reflat=dataSet(site).measurements.lat(560);% The turn occurs around point with index 560
%         reflon=dataSet(site).measurements.lon(560);
...
%         reflat=dataSet(site).measurements.lat(824);% The turn occurs around point with index 560
%         reflon=dataSet(site).measurements.lon(824);
%         [arclen,~]=distance(Lat(z),Long(z),reflat,reflon);
%         R2=arclen*R*pi/180;
%         [arclen,~]=distance(Sitelat,Sitelon,reflat,reflon);
%         R3=arclen*R*pi/180;
